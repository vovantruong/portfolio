				...
				<div className={cx('wrapper')}>
						...
						<div className={cx('card-intro')}>
							...
							<div className={cx('desc-area')}>
								...
								<p className={cx('phone')}>
									Phone:
									<span title="Copy" onClick={() => navigator.clipboard.writeText('0702378854')}>
										&nbsp;(+84) 0702378854
									</span>
								</p>
								<p className={cx('email')}>
									...
									<span
										title="Copy"
										onClick={() => navigator.clipboard.writeText('vtruong1007@gmail.com')}
									>
					...
					<div className={cx('contact-form')} data-aos="fade-left">
						<form ref={formRef} className={cx('form')} onSubmit={handleSubmit(onSubmit)} autoComplete="off">
							...
							<InputField label="Email" id="email" {...register('email')} error={errors.email} />

							<InputField label="Subject" id="subject" {...register('subject')} error={errors.subject} />
